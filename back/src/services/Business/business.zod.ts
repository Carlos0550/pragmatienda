...
export const updateBusinessSchema = z.object({
    ...
    shippingOriginStreet: z.string().min(2).max(120).optional(),
    shippingOriginNumber: z.string().min(1).max(20).optional(),
    shippingOriginCity: z.string().min(2).max(120).optional(),
    shippingOriginPostalCode: z.string().min(3).max(20).optional(),
