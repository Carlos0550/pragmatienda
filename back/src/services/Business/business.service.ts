    ...
    try {
      ...
      return {
        ...
        data: {
          ...
          businessHours: b.businessHours ?? undefined,
          shippingOriginStreet: b.shippingOriginStreet ?? undefined,
          shippingOriginNumber: b.shippingOriginNumber ?? undefined,
          shippingOriginCity: b.shippingOriginCity ?? undefined,
          shippingOriginPostalCode: b.shippingOriginPostalCode ?? undefined,
  ...
  async manageBusiness(
    ...
    try {
      ...
      const updatePayload = {
        ...
        ...(data.businessHours ? { businessHours: data.businessHours.trim() } : {}),
        ...(data.shippingOriginStreet ? { shippingOriginStreet: data.shippingOriginStreet.trim() } : {}),
        ...(data.shippingOriginNumber ? { shippingOriginNumber: data.shippingOriginNumber.trim() } : {}),
        ...(data.shippingOriginCity ? { shippingOriginCity: data.shippingOriginCity.trim() } : {}),
        ...(data.shippingOriginPostalCode ? { shippingOriginPostalCode: data.shippingOriginPostalCode.trim() } : {}),
